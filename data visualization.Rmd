...
# Data import
#meteo_2024 <- read_csv("Màster en Data Science/3r semestre/Visualització de dades/PAC 2/meteo_2024.csv")
meteo_2024 <- read.csv("meteo_2024.csv")
...
freq_data %>%
  ...
  theme(
    ...
    plot.title = element_text(color = "black", family = my_font, size = 20, face = "bold"),
    plot.caption = element_text(color = "grey50", family = my_font, size = 11),
